...
<div class="head-bread">
    ...
    <div class="container">
            <div class="col-md-6">
              <p align="justify">Form jasa latihan digunakan untuk melakukan pendaftaran latihan musik / yang akan dilaksanakan ditempat kami,
                             ...
                             <?php
                                ...
                                if (!empty($data)) {
                                  foreach ($data as $key => $value) {
                                    echo '<option value="'.$value->jenis_jasa_id.'">'.$value->nama_jasa.' ('.$this->all_model->format_harga($value->harga_jasa).' / Bulan)</option>';
                                  }
                                }
                              ?>
                           </select>
